    ...
    <StyledWrapper $replaceVisible={replaceVisible}>
      <div className="bruno-search-bar" ref={containerRef} data-testid="codemirror-search-bar">
        <button
          ...
          title={replaceVisible ? t('Hide replace') : t('Show replace')}
        ...
        <div className="search-replace-rows">
          <div className="search-row">
            ...
            />
            <span className="searchbar-result-count" data-testid="codemirror-search-result-count">{isDebouncing ? '...' : matchCount > 0 ? `${matchIndex + 1} / ${matchCount}` : t('0 results')}</span>
            <ToolHint text={t('Regex search')} toolhintId="searchbar-regex-toolhint" place="top">
            ...
            <ToolHint text={t('Case sensitive')} toolhintId="searchbar-case-toolhint" place="top">
            ...
            <ToolHint text={t('Whole word')} toolhintId="searchbar-wholeword-toolhint" place="top">
            ...
            <button type="button" className="searchbar-icon-btn" title={t('Previous (Shift+Enter)')} onClick={handlePrev} data-testid="codemirror-search-prev-btn"><IconArrowUp size={14} /></button>
            <button type="button" className="searchbar-icon-btn" title={t('Next (Enter)')} onClick={handleNext} data-testid="codemirror-search-next-btn"><IconArrowDown size={14} /></button>
            <button type="button" className="searchbar-icon-btn" title={t('Close')} onClick={handleSearchBarClose} data-testid="codemirror-search-close-btn"><IconX size={14} /></button>
          </div>
          {replaceVisible && !readOnly && (
            <div className="replace-row">
              ...
              />
              <ToolHint text={t('Replace')} toolhintId="searchbar-replace-toolhint" place="top">
                <button type="button" aria-label={t('Replace')} aria-disabled={isReplaceDisabled} className="searchbar-icon-btn searchbar-replace-btn" onClick={handleReplace} data-testid="codemirror-search-replace-btn"><IconReplace size={15} /></button>
              </ToolHint>
              <ToolHint text={t('Replace all')} toolhintId="searchbar-replaceall-toolhint" place="top">
                <button type="button" aria-label={t('Replace all')} aria-disabled={isReplaceDisabled} className="searchbar-icon-btn searchbar-replace-btn" onClick={handleReplaceAll} data-testid="codemirror-search-replaceall-btn"><IconArrowsExchange2 size={15} /></button>
              </ToolHint>
            </div>
          )}
        </div>
