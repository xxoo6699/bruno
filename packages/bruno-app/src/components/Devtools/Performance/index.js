...
const getProcessOptions = (processes, translate) => {
  return [
    { value: 'cumulative', label: translate('Cumulative (All Processes)') },
...
const Performance = () => {
  ...
  const renderCumulativeView = () => (
    <div className="system-resources">
      <h2>{t('System Resources')}</h2>
      <div className="resource-cards">
        <SystemResourceCard
          icon={IconCpu}
          title={t('CPU Usage')}
          value={`${systemResources.cpu.toFixed(1)}%`}
          subtitle={t('Total CPU usage')}
        ...
        <SystemResourceCard
          icon={IconServer}
          title={t('Process ID')}
          value={systemResources.pid || t('N/A')}
          subtitle={t('Main process PID')}
          color="default"
        />
      </div>
    </div>
      ...
      <div className="system-resources">
        ...
        <div className="resource-cards">
          ...
          <SystemResourceCard
            ...
            subtitle={t('Current memory usage')}
