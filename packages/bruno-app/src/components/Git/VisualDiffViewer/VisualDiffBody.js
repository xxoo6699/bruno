      ...
      <table className="diff-table">
        <thead>
          <tr>
            ...
            <th className="checkbox-cell"></th>
            <th>{t('File Path')}</th>
            <th style={{ width: '100px' }}>{t('Content Type')}</th>
          </tr>
        </thead>
        <tbody>
    ...
    return (
      <>
        {(currentQuery || otherQuery) && (
          <div>
            <div className="diff-section-header">{t('Query')}</div>
            <div className="code-diff-content">{renderLineDiff(queryDiff)}</div>
          </div>
        )}
        {(currentVariables || otherVariables) && (
          <div>
            <div className="diff-section-header">{t('Variables')}</div>
          ...
          <table className="diff-table">
            ...
            <tbody>
              <tr className={modeStatus}>
                ...
                <td className="key-cell">{t('Body Mode')}</td>
