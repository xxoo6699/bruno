...
const AwsV4Auth = ({ item, collection, updateAuth, request, save }) => {
  ...
  return (
    <StyledWrapper className="mt-2 w-full">
      <label className="block mb-1">{t('Access Key ID')}</label>
      ...
      <label className="block mb-1">{t('Secret Access Key')}</label>
      ...
      <label className="block mb-1">{t('Session Token')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
      ...
      <label className="block mb-1">{t('Service')}</label>
      <div className="single-line-editor-wrapper mb-3">
        <SingleLineEditor
