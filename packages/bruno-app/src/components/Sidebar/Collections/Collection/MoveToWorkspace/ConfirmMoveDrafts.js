      ...
      >
        ...
        {currentTransientDrafts.length > 0 && (
          <div className="mt-4">
            ...
            <p className="text-xs transient-hint mb-3">
              {t('These requests need to be saved individually before moving the collection.')}
            </p>
        ...
        <div className="flex justify-between mt-6">
          ...
          <div>
            ...
            >
              {isMoving ? t('Moving...') : currentDrafts.length > 1 ? t('Save All and Move') : t('Save and Move')}
            </Button>
          </div>
        </div>
      </Modal>
