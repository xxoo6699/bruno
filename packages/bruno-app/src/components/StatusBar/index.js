      ...
      <div className="status-bar">
        <div className="status-bar-section">
          <div className="status-bar-group">
            <ToolHint text={t('Preferences')} toolhintId="Preferences" place="top-start" offset={10}>
              <button
            ...
            <ToolHint text={t('Notifications')} toolhintId="Notifications" place="top" offset={10}>
              <div className="status-bar-button">
                <Notifications />
              </div>
            </ToolHint>

            <ToolHint text={t('GitHub Repository')} toolhintId="GitHub" place="top" offset={10}>
              <button
                className="status-bar-button"
                onClick={() => {
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <div className="console-button-content">
                ...
                <span className="console-label">{t('Search')}</span>
              </div>
            </button>
            ...
            <button
              ...
              tabIndex={0}
              aria-label={t('Open Cookies')}
            >
              <div className="console-button-content">
                <IconCookie size={16} strokeWidth={1.5} aria-hidden="true" />
                <span className="console-label">{t('Cookies')}</span>
              </div>
            </button>
            ...
            <button
              ...
              tabIndex={0}
              aria-label={errorCount > 0 ? t('Open Dev Tools ({{count}} errors)', { count: errorCount }) : t('Open Dev Tools')}
            >
              <div className="console-button-content">
                <IconTool size={16} strokeWidth={1.5} aria-hidden="true" />
                <span className="console-label">{t('Dev Tools')}</span>
                {errorCount > 0 && (
